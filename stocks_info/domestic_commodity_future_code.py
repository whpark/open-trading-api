...
def get_domestic_com_future_master_dataframe(base_dir):
    ...
    #os.chdir(base_dir) # side effect!

    fo_com_code_zip = zipfile.ZipFile(base_dir + 'fo_com_code.mst.zip')
    fo_com_code_zip.extractall(base_dir)
    ...
    DF.to_excel(base_dir + 'fo_com_code.xlsx',index=False)  # 현재 위치에 엑셀파일로 저장
